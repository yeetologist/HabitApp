...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvTitle: TextView = itemView.findViewById(R.id.item_random_tv_title)
        private val tvTime: TextView = itemView.findViewById(R.id.item_random_tv_time)
        private val tvMinutes: TextView = itemView.findViewById(R.id.item_random_tv_minutes)
        private val ivPriority: ImageView = itemView.findViewById(R.id.item_random_priority_level)
        private val btnCountDown: Button = itemView.findViewById(R.id.btn_random_count_down)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            // Example: Set priority icon based on PageType
            when (pageType) {
